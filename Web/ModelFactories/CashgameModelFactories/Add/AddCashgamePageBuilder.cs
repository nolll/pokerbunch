...
namespace Web.ModelFactories.CashgameModelFactories.Add
{
    public class AddCashgamePageBuilder : IAddCashgamePageBuilder
    {
        ...
        public AddCashgamePageBuilder(IPagePropertiesFactory pagePropertiesFactory)
        {
        ...
        public AddCashgamePageModel Build(Homegame homegame, IEnumerable<string> locations, AddCashgamePostModel postModel)
        {
