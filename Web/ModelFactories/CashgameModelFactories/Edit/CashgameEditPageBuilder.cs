...
{
    public class CashgameEditPageBuilder : ICashgameEditPageBuilder
    {
        private readonly IPagePropertiesFactory _pagePropertiesFactory;
        private readonly IGlobalization _globalization;

        public CashgameEditPageBuilder(
        ...
        public CashgameEditPageModel Build(Homegame homegame, Cashgame cashgame, IEnumerable<string> locations, CashgameEditPostModel postModel)
        {
