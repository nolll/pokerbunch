...
export { default as AmountFact } from './AmountFact.vue';
export { default as OverallFacts } from './OverallFacts.vue';
export { default as SingleGameFacts } from './SingleGameFacts.vue';
export { default as TotalFacts } from './TotalFacts.vue';
