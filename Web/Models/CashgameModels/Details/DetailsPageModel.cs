...
namespace Web.Models.CashgameModels.Details{
	...
	public class DetailsPageModel : HomegamePageModel {
        ...
        public ResultTableModel ResultTableModel { get; set; }

		public DetailsPageModel(User user, Homegame homegame, Cashgame cashgame, Player player, List<int> years, bool isManager, Cashgame runningGame = null)
