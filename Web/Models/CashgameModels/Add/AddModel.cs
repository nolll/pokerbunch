...
namespace Web.Models.CashgameModels.Add{
	...
	public class AddModel : HomegamePageModel {
		...
		public AddModel(User user, Homegame homegame, Cashgame cashgame, List<string> locations, List<int> years = null, Cashgame runningGame = null)
