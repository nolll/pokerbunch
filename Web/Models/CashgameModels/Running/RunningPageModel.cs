...
namespace Web.Models.CashgameModels.Running{
	...
	public class RunningPageModel : HomegamePageModel {
        ...
        public StatusTableModel StatusTableModel { get; set; }
        public bool ShowTable { get; set; }

        public UrlModel ChartDataUrl { get; set; }
        public bool ShowChart { get; set; }

		public RunningPageModel(User user, Homegame homegame, Cashgame cashgame, Player player, List<int> years, bool isManager, ITimeProvider timer, Cashgame runningGame = null)
