...
import {
  GameArchiveStoreGetters,
  GameArchiveStoreActions,
  GameArchiveStoreMutations,
  GameArchiveStoreState,
} from '@/store/helpers/GameArchiveStoreHelpers';
...
export default {
  ...
  getters: {
    ...
    [GameArchiveStoreGetters.CurrentYearPlayers]: (state, getters) => {
      return playerSorter.sort(
        archiveHelper.getPlayers(getters[GameArchiveStoreGetters.CurrentYearGames]),
        CashgamePlayerSortOrder.Winnings
      );
    },
