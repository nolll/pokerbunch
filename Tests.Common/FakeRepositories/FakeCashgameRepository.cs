...
namespace Tests.Common.FakeRepositories
{
    public class FakeCashgameRepository : ICashgameRepository
    {
        ...
        private IList<Cashgame> GetGames(DateTime? secondGameStartTime = null)
        {
            ...
            {
                new Cashgame(TestData.BunchA.Slug, TestData.BunchA.Id, TestData.LocationIdA, GameStatus.Finished, TestData.CashgameIdA, checkpoints1),
                new Cashgame(TestData.BunchA.Slug, TestData.BunchA.Id, TestData.LocationIdB, GameStatus.Finished, TestData.CashgameIdB, checkpoints2)
            };
        }
        ...
        private IList<Cashgame> GetGames(int gameCount)
        {
            ...
            for (var i = 0; i < gameCount; i++)
            {
                ...
                games.Add(new Cashgame(TestData.BunchA.Slug, TestData.BunchA.Id, TestData.LocationIdA, GameStatus.Finished, TestData.CashgameIdA, checkpoints));
        ...
        {
            _list.Add(new Cashgame(TestData.BunchA.Slug, TestData.BunchA.Id, TestData.LocationIdC, GameStatus.Running, TestData.CashgameIdC, TestData.RunningGameCheckpoints));
        }
        ...
        public void SetupRunningGameWithCashoutCheckpoint()
        {
            ...
            _list.Add(new Cashgame(TestData.BunchA.Slug, TestData.BunchA.Id, TestData.LocationIdC, GameStatus.Running, TestData.CashgameIdC, checkpoints1));
        }
        ...
        public void SetupEmptyGame()
        {
            var checkpoints1 = new List<Checkpoint>();
            _list.Clear();
            _list.Add(new Cashgame(TestData.BunchA.Slug, TestData.BunchA.Id, TestData.LocationIdA, GameStatus.Running, TestData.CashgameIdA, checkpoints1));
        }
