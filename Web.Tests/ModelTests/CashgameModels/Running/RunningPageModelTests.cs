...
namespace Web.Tests.ModelTests.CashgameModels.Running{
	...
	class RunningPageModelTests : MockContainer {
		...
		*/
        ...
        public void StatusTableModel_WithCreatedGame_IsCorrectType(){
            ...
            Assert.IsInstanceOf<StatusTableModel>(sut.StatusTableModel);
		}
		...
		*/
		...
		private RunningPageModel GetSut(){
			return new RunningPageModel(new User(), _homegame, _cashgame, _player, null, _isManager, TimeProviderMock.Object);
		}
