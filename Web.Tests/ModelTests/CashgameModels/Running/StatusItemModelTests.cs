...
namespace Web.Tests.ModelTests.CashgameModels.Running{
	...
	class StatusItemModelTests : MockContainer {
		...
		private StatusItemModel GetSut(){
			return new StatusItemModel(_homegame, _cashgame, _result, _isManager, TimeProviderMock.Object);
		}
