...
namespace Web.Tests.ModelTests.CashgameModels.Matrix{
    ...
    public class MatrixTableRowModelTests {
		...
		public void TableRow_CellModelsAreSet(){
			...
			Assert.IsInstanceOf<MatrixTableCellModel>(sut.CellModels[0]);
		}

		private MatrixTableRowModel GetSut(){
		    ...
		    return new MatrixTableRowModel(_homegame, suite, _result, _rank);
		}
