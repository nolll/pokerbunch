...
namespace Web.Tests.ModelTests.CashgameModels.Matrix{
	...
	public class MatrixTableColumnHeaderModelTests {
        ...
        private MatrixTableColumnHeaderModel GetSut()
        {
            return new MatrixTableColumnHeaderModel(_homegame, _cashgame, _showYear);
        }
