...
namespace Core.UseCases
{
    public class PlayerDetails
    {
        ...
        public PlayerDetails(IBunchRepository bunchRepository, IPlayerRepository playerRepository, CashgameService cashgameService, IUserRepository userRepository)
        {
