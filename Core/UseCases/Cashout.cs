...
namespace Core.UseCases
{
    public class Cashout
    {
        ...
        public Cashout(BunchService bunchService, ICashgameRepository cashgameRepository, IPlayerRepository playerRepository, ICheckpointRepository checkpointRepository, UserService userService)
        {
