...
namespace Core.UseCases
{
    public class PlayerBadges
    {
        ...
        public PlayerBadges(IBunchRepository bunchRepository, ICashgameRepository cashgameRepository, IPlayerRepository playerRepository, UserService userService)
        {
