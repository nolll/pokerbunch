...
namespace Tests.Core.UseCases
{
    public class EditBunchTests : TestBase
    {
        ...
        private const string ValidTimeZone = Constants.LocalTimeZoneName;
        ...
        {
            var request = new EditBunchRequest(Constants.SlugA, Description, "", ValidCurrencyLayout, ValidTimeZone, HouseRules, DefaultBuyin);
        ...
        {
            var request = new EditBunchRequest(Constants.SlugA, Description, ValidCurrencySymbol, "", ValidTimeZone, HouseRules, DefaultBuyin);
        ...
        {
            var request = new EditBunchRequest(Constants.SlugA, Description, ValidCurrencySymbol, ValidCurrencyLayout, "", HouseRules, DefaultBuyin);
        ...
        {
            var request = new EditBunchRequest(Constants.SlugA, Description, ValidCurrencySymbol, ValidCurrencyLayout, "a", HouseRules, DefaultBuyin);
        ...
        {
            var request = new EditBunchRequest(Constants.SlugA, Description, ValidCurrencySymbol, ValidCurrencyLayout, ValidTimeZone, HouseRules, DefaultBuyin);
        ...
        public void EditBunch_ValidData_ReturnUrlIsCorrect()
        {
            ...
            Assert.AreEqual("/bunch-a/homegame/details", result.ReturnUrl.Relative);
        }

        private EditBunchInteractor Sut
        {
            get
            {
                return new EditBunchInteractor(Repos.Bunch);
            }
        }
    }
}