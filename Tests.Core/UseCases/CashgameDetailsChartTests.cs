...
namespace Tests.Core.UseCases
{
    public class CashgameDetailsChartTests : TestBase
    {
        ...
        {
            var request = new CashgameDetailsChartRequest(Constants.SlugA, DateTime.Now, Constants.DateStringA);
        ...
        public void PlayerItems_RunningGame_TwoPlayersWithTwoCheckpointsEach()
        {
            ...
            var request = new CashgameDetailsChartRequest(Constants.SlugA, DateTime.Now);
            var result = Sut.Execute(request);
