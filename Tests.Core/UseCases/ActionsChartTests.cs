...
namespace Tests.Core.UseCases
{
    public class ActionsChartTests : TestBase
    {
        ...
        {
            var request = new ActionsChart.Request(TestData.UserNameA, TestData.SlugA, TestData.DateStringA, TestData.PlayerIdA, DateTime.UtcNow);
        ...
        {
            var request = new ActionsChart.Request(TestData.UserNameA, TestData.SlugA, TestData.DateStringA, TestData.PlayerIdB, DateTime.UtcNow);
        ...
        {
            var request = new ActionsChart.Request(TestData.UserNameA, TestData.SlugA, TestData.DateStringB, TestData.PlayerIdA, DateTime.UtcNow);
        ...
        {
            var request = new ActionsChart.Request(TestData.UserNameA, TestData.SlugA, TestData.DateStringB, TestData.PlayerIdB, DateTime.UtcNow);
        ...
        public void ActionsChart_RunningGame_CheckpointItemsAreCorrect()
        {
            ...
            var request = new ActionsChart.Request(TestData.UserNameA, TestData.SlugA, TestData.DateStringC, TestData.PlayerIdA, TestData.StartTimeC.AddHours(1));
