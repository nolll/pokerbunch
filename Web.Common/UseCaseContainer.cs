...
namespace Web.Common
{
    public class UseCaseContainer
    {
        ...
        public EditBunchForm EditBunchForm { get { return new EditBunchForm(_deps.BunchRepository, _deps.UserRepository, _deps.PlayerRepository); } }
        public EditBunch EditBunch { get { return new EditBunch(_deps.BunchRepository, _deps.UserRepository, _deps.PlayerRepository); } }
        ...
        public JoinBunchConfirmation JoinBunchConfirmation { get { return new JoinBunchConfirmation(_deps.BunchRepository, _deps.UserRepository, _deps.PlayerRepository); } }
        ...
        public TopList TopList { get { return new TopList(_deps.BunchRepository, _deps.CashgameRepository, _deps.PlayerRepository, _deps.UserRepository); } }
        public CurrentRankings CurrentRankings { get { return new CurrentRankings(_deps.BunchRepository, _deps.CashgameRepository, _deps.PlayerRepository, _deps.UserRepository); } }
        ...
        public CashgameFacts CashgameFacts { get { return new CashgameFacts(_deps.BunchRepository, _deps.CashgameRepository, _deps.PlayerRepository, _deps.UserRepository); } }
        public CashgameList CashgameList { get { return new CashgameList(_deps.BunchRepository, _deps.CashgameRepository, _deps.UserRepository, _deps.PlayerRepository); } }
        public AddCashgameForm AddCashgameForm { get { return new AddCashgameForm(_deps.BunchRepository, _deps.CashgameRepository, _deps.UserRepository, _deps.PlayerRepository); } }
        ...
        public InvitePlayer InvitePlayer { get { return new InvitePlayer(_deps.BunchRepository, _deps.PlayerRepository, _deps.MessageSender, _deps.UserRepository); } }
        public InvitePlayerForm InvitePlayerForm { get { return new InvitePlayerForm(_deps.BunchRepository, _deps.PlayerRepository, _deps.UserRepository); } }
        ...
        public AddApp AddApp { get { return new AddApp(_deps.AppRepository, _deps.UserRepository); } }
    }
}