...
namespace Tests.Infrastructure.Factories
{
    ...
    public class CashgameResultFactoryTests : TestBase
    {
        ...
        {
            var buyinCheckPoint =
                A.Checkpoint.WithTimestamp(new DateTime())
                    .WithStack(100)
                    .WithAmount(100)
        ...
        public void GetBuyinTime_WithBuyinCheckpoint_ReturnsBuyinTime()
        {
            ...
            var buyinCheckpoint =
                A.Checkpoint.WithTimestamp(buyinTime).WithAmount(200).OfType(CheckpointType.Buyin).Build();
            var otherCheckpoint = A.Checkpoint.Build();
        ...
        public void GetCashoutTime_WithCashoutCheckpoint_ReturnsCashoutTime()
        {
            ...
            var cashoutCheckpoint =
                A.Checkpoint.WithTimestamp(cashoutTime).WithStack(200).OfType(CheckpointType.Cashout).Build();
            var otherCheckpoint = A.Checkpoint.Build();
        ...
        public void GetPlayedTime_MissingStartTime_ReturnsZero()
        {
            _checkpoints = new List<Checkpoint>
            {
                A.Checkpoint.WithTimestamp(DateTime.Parse("2010-01-01 01:00:00")).Build()
            };
        ...
        public void GetPlayedTime_MissingEndTime_ReturnsZero()
        {
            _checkpoints = new List<Checkpoint>
            {
                A.Checkpoint.WithTimestamp(DateTime.Parse("2010-01-01 02:00:00")).Build()
            };
